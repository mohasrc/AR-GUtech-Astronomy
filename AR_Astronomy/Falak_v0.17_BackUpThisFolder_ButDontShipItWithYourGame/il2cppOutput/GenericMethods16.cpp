...
FINALLY_0035:
			{
				Enumerator_Dispose_mD9DC3E3C3697830A4823047AB29A77DBBB5ED419((&V_1), il2cpp_rgctx_method(method->rgctx_data, 6));
				return;
			}
		});
		try
...
IL_002a_1:
			{
				bool L_6;
				L_6 = Enumerator_MoveNext_mE921CC8F29FBBDE7CC3209A0ED0D921D58D00BCB((&V_1), il2cpp_rgctx_method(method->rgctx_data, 5));
				if (L_6)
				{
					goto IL_0014_1;
				}
...
IL_0044:
	{
		...
		NullCheck(L_7);
		List_1_Clear_m16C1F2C61FED5955F10EB36BC1CB2DF34B128994_inline(L_7, il2cpp_rgctx_method(method->rgctx_data, 7));
	}
...
IL_002a:
	{
		...
		NullCheck(L_12);
		((Link_t3E237FC972997681510F43C6555571385C91BE05*)L_12)->___Finger_0 = L_13;
		Il2CppCodeGenWriteBarrier((void**)(&((Link_t3E237FC972997681510F43C6555571385C91BE05*)L_12)->___Finger_0), (void*)L_13);
...
IL_0014_1:
			{
				...
				RuntimeObject* L_5 = V_2;
				NullCheck(L_5);
				Finger_tF0FFA146E12F3DEF1F354487835AA90A59834AB8* L_6 = (Finger_tF0FFA146E12F3DEF1F354487835AA90A59834AB8*)((Link_t3E237FC972997681510F43C6555571385C91BE05*)L_5)->___Finger_0;
...
IL_0036_1:
			{
				bool L_10;
				L_10 = Enumerator_MoveNext_mE921CC8F29FBBDE7CC3209A0ED0D921D58D00BCB((&V_1), il2cpp_rgctx_method(method->rgctx_data, 5));
				if (L_10)
				{
					goto IL_0014_1;
				}
